...
class Rack::Attack
  ...
  throttle('throttle_authenticated_api', limit: 30_000, period: 15.minutes) do |req|
    req.authenticated_user_id if req.api_request?
  end

  throttle('throttle_per_token_api', limit: 10_000, period: 15.minutes) do |req|
  ...
  throttle('throttle_media_proxy', limit: 50_000, period: 10.minutes) do |req|
